...
insert into tb_product (name, description, price, url_Image, category_id) values ('COMPUTADOR GAMER COOLER MASTER COOLING X','COMPUTADOR GAMER COOLER MASTER COOLING X, AMD RYZEN 9 7950X3D, GEFORCE RTX 4080 16GB, 64GB DDR5, SSD M.2 4TB, 850W + MONITOR COOLER MASTER GP27U 27',44599.99, 'https://media.pichau.com.br/media/catalog/product/cache/2f958555330323e505eba7ce930bdf27/c/o/cooling-x-cooler-master-27-pichau-06.jpg',1);
...
insert into tb_product (name, description, price, url_Image, category_id) values ('CONSOLE SONY PLAYSTATION 5 SLIM EDICAO DIGITAL','CONSOLE SONY PLAYSTATION 5 SLIM EDICAO DIGITAL, SSD 1TB, 1 CONTROLE, BRANCO, 1214B',3799.99, 'https://media.pichau.com.br/media/catalog/product/cache/2f958555330323e505eba7ce930bdf27/1/2/1214b2.jpg', 3);
